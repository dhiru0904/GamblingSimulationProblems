...
public class GamblingTwentyDay {
    public GamblingTwentyDay() {
    ...
    public static void main(String[] args) {
        ...
        GamblingTwentyDay gambling = new GamblingTwentyDay();
        System.out.println();
    ...
    public static void startsGambling(GamblingTwentyDay gambling) {
        //Declaring variables
        Random random = new Random();
        int highestStake = (int) (stakePerDay + (stakePerDay * percentage));
        int lowestStake = (int) (stakePerDay - (stakePerDay * percentage));

        //Check random if win or loose with the condition for 20 days
